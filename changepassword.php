      ...
      <div class="container">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb ftco-consult">
            ...
            <div class="form-group <?php echo (!empty($new_password_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="password" placeholder="নতুন পাসওয়ার্ড" name="new_password" class="form-control" value="<?php echo $new_password; ?>">
                <span class="help-block"><?php echo $new_password_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
               
                <input type="password" placeholder="কনফার্ম পাসওয়ার্ড" name="confirm_password" class="form-control">
                <span class="help-block"><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="পরিবর্তন করুন">
                <a class="btn btn-link" href="profile/profile.php">বাতিল করুন</a>
            </div>
        </form>
						</div>
					</div>
